<?php 
    /**REQUERIMOS DEL MODELO ESTUDIANTE PARA QUE PROCESE LOS DATOS, QUE SE ENVIARAN A LAS VISTAS CORRESPONDIENTES*/
    ...
    class estudiante_controller{
        ...
        /**CONTROLADOR get_datosE. PERMITE CREAR UN NUEVO USUARIO A PARTIR DE LOS DATOS DEL FORMULARIO, TAMBIEN REALIZAR LA FUNCION DE ACA
         REALIZA UN UPDATE A LA BASE DE DATOS EN EL CASO DE QUE EL ID TENGA VALOR
        */
        function get_datosE(){
