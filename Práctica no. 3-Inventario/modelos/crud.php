<?php 
    ...
    class Datos extends Conexion{
        ...
        public function vistaProductsModel($tabla){
            ...
            c.name_category AS 'categoria' FROM $tabla p INNER JOIN categorias c ON p.id_category = c.id_category");
       ...
       se dan los valores y se genera la inserccion */          
        ...
        public function actualizarProductsModel($datosModel,$tabla){
            ...
            price_product = :precio, stock = :stock, id_category = :categoria WHERE id_product = :id");
        ...
        public function vistaHistorialModel($tabla){
            $stmt = Conexion::conectar()->prepare("SELECT CONCAT(u.firstname,':',u.user_name) AS 'usuario',
            p.name_product AS 'producto', h.date AS 'fecha', h.reference AS 'referencia', h.note AS 'nota', 
            h.quantity AS 'cantidad' FROM $tabla h INNER JOIN productos p ON h.id_producto = p.id_product INNER JOIN
            usuarios u ON h.user_id = u.user_id");
            $stmt->execute();
            return $stmt->fetchAll();
            $stmt->close();
        }
        ...
        public function insertarHistorialModel($datosModel, $tabla){
            ...
            VALUES(:user,:cantidad,:producto,:note,:reference)");
