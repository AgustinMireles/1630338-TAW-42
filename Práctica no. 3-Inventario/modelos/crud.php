<?php 
    ...
    class Datos extends Conexion{
        ...
        public function vistaProductsModel($tabla){
            ...
            c.name_category AS 'categoria' FROM $tabla p INNER JOIN categories c ON p.id_category = c.id_category");
        ...
        public function pullProductsModel(){
        ...
        public function vistaHistorialModel($tabla){
            ...
            h.quantity AS 'cantidad' FROM $tabla h INNER JOIN products p ON h.id_producto = p.id_product INNER JOIN
