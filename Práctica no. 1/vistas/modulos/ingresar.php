                ...
                <div class="p-5">
                  ...
                  <form class="user" method="post">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" name="usuarioIngreso" -describedby="emailHelp" placeholder="Escriba Usuario..." required>
                    </div>
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" name="passwordIngreso" placeholder="Contraseña" required>
                    </div>
                  ...
                  <div class="text-center">
                    <a class="small" href="index.php?action=registro">Create an Account!</a>
                  </div>
                </div>
              </div>
            </div>
