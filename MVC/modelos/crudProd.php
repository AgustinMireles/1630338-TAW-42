<?php
    ...
    class DatosProd extends Conexion{
       ...
       static public function mdlregistroProducto($datos,$tabla){
            ...
            $stmt = Conexion::conectar()->prepare("INSERT INTO $tabla (nombre, descripcion, precio_compra, precio_venta, inventario) 
            VALUES (:nombre, :descripcion, :precio_compra, :precio_venta, :inventario)");
        ...
        public function mdlverProductos($tabla){
            $stmt = Conexion::conectar()->prepare("SELECT id, nombre, descripcion, precio_compra, precio_venta, inventario FROM $tabla");
            $stmt->execute();
        ...
        public function mdleditarProducto($datoModelo, $tabla){
        ...
        static public function mdlactualizarProducto($datosModelo, $tabla){
            $stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombre = :nombre, descripcion = :descripcion, precio_compra = :precio_compra, precio_venta = :precio_venta, inventario = :inventario WHERE id = :id");
